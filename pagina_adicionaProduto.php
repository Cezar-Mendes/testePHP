...
<body>
    <div class="container-fluid">
        ...
        <div class="p-3 mb-2 bg-secondary text-black">
            <form action="movimentaEstoque.php" method="POST">
                ...
                <div class="Formulario">
                                    ...
                                    ?>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td div class="text-white"><?php echo $imprime['id']; ?></td>
                    ...
                    ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm">
                                <input type="number" class="form-control" name="codigo" placeholder="Código do Produto">
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm">
                                <input type="number" class="form-control" name="campoQtde" placeholder="Quantidade">
                            </div>
