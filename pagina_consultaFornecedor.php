...
<body>
    <div class="container-fluid">
        ...
        <div class="p-3 mb-2 bg-secondary text-black">
            ...
            <?php
            $fornecedor = "SELECT * from fornecedor JOIN empresa where empresa.cnpj = fornecedor.empresaCnpj order by fornecedor.nome";
            $result_id = @mysqli_query($link, $fornecedor) or die("Erro");
            ...
            ?>
                <div class="container-fluid">
                    <div class="p-3 mb-2 bg-primary text-black">
                        <h2 align="center">FORNECEDORES</h2>
                        <table class="table table-hover" id="minhaTabela">
                            ...
                            while ($imprime = $result_id->fetch_array()) {
                                $data = $imprime['dataCadastro'];
                            ?>
                                <tbody>
                                    <tr>

                                        <td div class="text-white"><?php echo $imprime['nome']; ?></td>
                                        <td div class="text-white"> <?php echo $imprime['docIdent']; ?></td>
                                        <td div class="text-white"><?php echo $imprime['nomeFantasia']; ?></td>
                                        <td div class="text-white"><?php echo date('d/m/Y', strtotime($data)); ?></td>
                                        <td div class="text-white"><?php echo $imprime['telefone']; ?></td>
